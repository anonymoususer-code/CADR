...
def get_argument_parser():
    ...
    parser.add_argument('--data_path', default='data/coco', type=str, help='path to datasets')
    parser.add_argument('--dataset', default='coco', help='dataset coco or f30k')
    ...
    parser.add_argument('--logger_name', default='runs/coco_all', help='Path to save Tensorboard log.')
    ...
    parser.add_argument('--f30k_img_path', type=str, default='data/f30k/images', help='the path of f30k images') 
    parser.add_argument('--coco_img_path', type=str, default='data/coco/coco_images', help='the path of coco images') 
    
    # vision transformer
    parser.add_argument('--img_res', type=int, default=224, help='the image resolution for ViT input') 
    parser.add_argument('--vit_type', type=str, default='dinov2', help='the type of vit model')   
    ...
    parser.add_argument('--aggr_ratio', type=float, default=0.6, help='the aggr rate for visual token')
    parser.add_argument('--sparse_ratio', type=float, default=0.8, help='the sprase rate for visual token') 
